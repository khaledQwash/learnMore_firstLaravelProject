                ...
                <div class="isotope-layout" data-default-filter="*" data-layout="fitRows" data-sort="original-order">
                    ...
                    <div class="row gy-4 portfolio-grid isotope-container" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
                            <div class="portfolio-card">
                                <div class="image-container">
                                    <img src="{{ asset('mySiteAssets/img/portfolio/portfolio-3.webp') }}" class="img-fluid"
                                        alt="Brand Identity" loading="lazy">
                                    <div class="overlay">
                                        <div class="overlay-content">
                                            <a href="{{ asset('mySiteAssets/img/portfolio/portfolio-3.webp') }}"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-web">
                            <div class="portfolio-card">
                                <div class="image-container">
                                    <img src="{{ asset('mySiteAssets/img/portfolio/portfolio-7.webp') }}" class="img-fluid"
                                        alt="E-commerce Platform" loading="lazy">
                                    <div class="overlay">
                                        <div class="overlay-content">
                                            <a href="{{ asset('mySiteAssets/img/portfolio/portfolio-7.webp') }}"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-print">
                            <div class="portfolio-card">
                                <div class="image-container">
                                    <img src="{{ asset('mySiteAssets/img/portfolio/portfolio-portrait-5.webp') }}"
                                        class="img-fluid" alt="Magazine Design" loading="lazy">
                                    <div class="overlay">
                                        <div class="overlay-content">
                                            <a href="{{ asset('mySiteAssets/img/portfolio/portfolio-portrait-5.webp') }}"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-motion">
                            <div class="portfolio-card">
                                <div class="image-container">
                                    <img src="{{ asset('mySiteAssets/img/portfolio/portfolio-8.webp') }}" class="img-fluid"
                                        alt="Motion Graphics" loading="lazy">
                                    <div class="overlay">
                                        <div class="overlay-content">
                                            <a href="{{ asset('mySiteAssets/img/portfolio/portfolio-8.webp') }}"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
                            <div class="portfolio-card">
                                <div class="image-container">
                                    <img src="{{ asset('mySiteAssets/img/portfolio/portfolio-9.webp') }}" class="img-fluid"
                                        alt="Logo Collection" loading="lazy">
                                    <div class="overlay">
                                        <div class="overlay-content">
                                            <a href="{{ asset('mySiteAssets/img/portfolio/portfolio-9.webp') }}"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-web">
                            <div class="portfolio-card">
                                <div class="image-container">
                                    <img src="{{ asset('mySiteAssets/img/portfolio/portfolio-portrait-8.webp') }}"
                                        class="img-fluid" alt="Mobile App Design" loading="lazy">
                                    <div class="overlay">
                                        <div class="overlay-content">
                                            <a href="{{ asset('mySiteAssets/img/portfolio/portfolio-portrait-8.webp') }}"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-print">
                            <div class="portfolio-card">
                                <div class="image-container">
                                    <img src="{{ asset('mySiteAssets/img/portfolio/portfolio-10.webp') }}" class="img-fluid"
                                        alt="Packaging Design" loading="lazy">
                                    <div class="overlay">
                                        <div class="overlay-content">
                                            <a href="{{ asset('mySiteAssets/img/portfolio/portfolio-10.webp') }}"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-motion">
                            <div class="portfolio-card">
                                <div class="image-container">
                                    <img src="{{ asset('mySiteAssets/img/portfolio/portfolio-11.webp') }}" class="img-fluid"
                                        alt="Brand Animation" loading="lazy">
                                    <div class="overlay">
                                        <div class="overlay-content">
                                            <a href="{{ asset('mySiteAssets/img/portfolio/portfolio-11.webp') }}"
